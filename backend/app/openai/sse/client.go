...
// original implementation from https://github.com/r3labs/sse
// lacked support for non GET requests and custom headers/body
// PR for merging this change back - https://github.com/r3labs/sse/pull/164
package sse
